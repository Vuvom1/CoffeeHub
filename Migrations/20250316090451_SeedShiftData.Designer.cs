...
namespace CoffeeHub.Migrations
{
    ...
    [Migration("20250316090451_SeedShiftData")]
            ...
            modelBuilder.Entity("CoffeeHub.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 16, 16, 4, 51, 189, DateTimeKind.Local).AddTicks(1780),
                            DateOfBirth = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            MonthlySalary = 0m,
                            Name = "Admin",
                            PhoneNumber = "0000000000",
                            UpdatedAt = new DateTime(2025, 3, 16, 16, 4, 51, 189, DateTimeKind.Local).AddTicks(1790)
                        });
                });
            ...
            modelBuilder.Entity("CoffeeHub.Models.Domains.Auth", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 16, 16, 4, 51, 189, DateTimeKind.Local).AddTicks(2810),
                            ...
                            Role = 0,
                            UpdatedAt = new DateTime(2025, 3, 16, 16, 4, 51, 189, DateTimeKind.Local).AddTicks(2810),
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("CoffeeHub.Models.Domains.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 16, 16, 4, 51, 189, DateTimeKind.Local).AddTicks(860),
                            CustomerLevel = 0,
                            DateOfBirth = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsAvailable = true,
                            Name = "Guest",
                            PhoneNumber = "0000000000",
                            Point = 0,
                            UpdatedAt = new DateTime(2025, 3, 16, 16, 4, 51, 189, DateTimeKind.Local).AddTicks(870)
                        });
                });
            ...
            modelBuilder.Entity("CoffeeHub.Models.Domains.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "Ho Chi Minh City",
                            AuthId = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedAt = new DateTime(2025, 3, 16, 16, 4, 51, 178, DateTimeKind.Local).AddTicks(1050),
                            DateOfBirth = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            PhoneNumber = "0000000000",
                            Role = 0,
                            UpdatedAt = new DateTime(2025, 3, 16, 16, 4, 51, 188, DateTimeKind.Local).AddTicks(6090)
                        });
                });
            ...
            modelBuilder.Entity("CoffeeHub.Models.Domains.Shift", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("dbb63771-edc4-4d57-820f-c5b471bafe0c"),
                            CreatedAt = new DateTime(2025, 3, 16, 16, 4, 51, 189, DateTimeKind.Local).AddTicks(4020),
                            EndTime = new TimeSpan(0, 12, 0, 0, 0),
                            Name = "Morning Shift",
                            StartTime = new TimeSpan(0, 6, 0, 0, 0),
                            UpdatedAt = new DateTime(2025, 3, 16, 16, 4, 51, 189, DateTimeKind.Local).AddTicks(4020)
                        },
                        new
                        {
                            Id = new Guid("dfb0a83b-b626-4234-a084-894a3c4b1140"),
                            CreatedAt = new DateTime(2025, 3, 16, 16, 4, 51, 189, DateTimeKind.Local).AddTicks(4400),
                            EndTime = new TimeSpan(0, 18, 0, 0, 0),
                            Name = "Afternoon Shift",
                            StartTime = new TimeSpan(0, 12, 0, 0, 0),
                            UpdatedAt = new DateTime(2025, 3, 16, 16, 4, 51, 189, DateTimeKind.Local).AddTicks(4400)
                        },
                        new
                        {
                            Id = new Guid("8ed2c9b3-60e3-4e36-a15d-5df987296de2"),
                            CreatedAt = new DateTime(2025, 3, 16, 16, 4, 51, 189, DateTimeKind.Local).AddTicks(4410),
                            EndTime = new TimeSpan(0, 22, 0, 0, 0),
                            Name = "Evening Shift",
                            StartTime = new TimeSpan(0, 18, 0, 0, 0),
                            UpdatedAt = new DateTime(2025, 3, 16, 16, 4, 51, 189, DateTimeKind.Local).AddTicks(4410)
                        });
                });

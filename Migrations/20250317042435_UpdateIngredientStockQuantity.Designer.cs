...
namespace CoffeeHub.Migrations
{
    ...
    [Migration("20250317042435_UpdateIngredientStockQuantity")]
    partial class UpdateIngredientStockQuantity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CoffeeHub.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 17, 11, 24, 34, 616, DateTimeKind.Local).AddTicks(5860),
                            DateOfBirth = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            MonthlySalary = 0m,
                            Name = "Admin",
                            PhoneNumber = "0000000000",
                            UpdatedAt = new DateTime(2025, 3, 17, 11, 24, 34, 616, DateTimeKind.Local).AddTicks(5860)
                        });
                });
            ...
            modelBuilder.Entity("CoffeeHub.Models.Domains.Auth", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 17, 11, 24, 34, 616, DateTimeKind.Local).AddTicks(6910),
                            ...
                            Role = 0,
                            UpdatedAt = new DateTime(2025, 3, 17, 11, 24, 34, 616, DateTimeKind.Local).AddTicks(6920),
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("CoffeeHub.Models.Domains.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 17, 11, 24, 34, 616, DateTimeKind.Local).AddTicks(4860),
                            CustomerLevel = 0,
                            DateOfBirth = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsAvailable = true,
                            Name = "Guest",
                            PhoneNumber = "0000000000",
                            Point = 0,
                            UpdatedAt = new DateTime(2025, 3, 17, 11, 24, 34, 616, DateTimeKind.Local).AddTicks(4870)
                        });
                });
            ...
            modelBuilder.Entity("CoffeeHub.Models.Domains.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "Ho Chi Minh City",
                            AuthId = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedAt = new DateTime(2025, 3, 17, 11, 24, 34, 604, DateTimeKind.Local).AddTicks(9670),
                            DateOfBirth = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            PhoneNumber = "0000000000",
                            Role = 0,
                            UpdatedAt = new DateTime(2025, 3, 17, 11, 24, 34, 615, DateTimeKind.Local).AddTicks(9810)
                        });
                });
            ...
            modelBuilder.Entity("CoffeeHub.Models.Domains.Shift", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3db88c22-3d11-45a3-a51d-690ebee77bd8"),
                            CreatedAt = new DateTime(2025, 3, 17, 11, 24, 34, 616, DateTimeKind.Local).AddTicks(8160),
                            EndTime = new TimeSpan(0, 12, 0, 0, 0),
                            Name = "Morning Shift",
                            StartTime = new TimeSpan(0, 6, 0, 0, 0),
                            UpdatedAt = new DateTime(2025, 3, 17, 11, 24, 34, 616, DateTimeKind.Local).AddTicks(8160)
                        },
                        new
                        {
                            Id = new Guid("09456c51-e73e-4c93-b443-e96e373ccf97"),
                            CreatedAt = new DateTime(2025, 3, 17, 11, 24, 34, 616, DateTimeKind.Local).AddTicks(8550),
                            EndTime = new TimeSpan(0, 18, 0, 0, 0),
                            Name = "Afternoon Shift",
                            StartTime = new TimeSpan(0, 12, 0, 0, 0),
                            UpdatedAt = new DateTime(2025, 3, 17, 11, 24, 34, 616, DateTimeKind.Local).AddTicks(8560)
                        },
                        new
                        {
                            Id = new Guid("81ec7d44-3ce7-4d9b-9ad3-ed983fd79feb"),
                            CreatedAt = new DateTime(2025, 3, 17, 11, 24, 34, 616, DateTimeKind.Local).AddTicks(8560),
